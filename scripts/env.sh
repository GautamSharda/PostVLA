...
export PYTHONPATH="${POSTVLA_ROOT}/third_party/FlashRT:${POSTVLA_ROOT}/third_party/RLinf:${POSTVLA_ROOT}/compat/openpi_patch:${POSTVLA_ROOT}/third_party/openpi/src:${POSTVLA_ROOT}/third_party/openpi/packages/openpi-client/src:${POSTVLA_ROOT}/sim:${POSTVLA_ROOT}:${PYTHONPATH:-}"
